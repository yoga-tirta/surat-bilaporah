...
if(isset($_POST["button"])){
  ...
  if($tb_pengajuan){
      header("location: ../tambah_data/tambah_skk.php?nama=$nama&tempat_lahir=$tempat_lahir&tgl_lahir=$tgl_lahir&gender=$gender&pekerjaan=$pekerjaan&alamat=$alamat&hari_meninggal=$hari_meninggal&tgl_meninggal=$tgl_meninggal&kode_surat=$kode_surat&tgl=$tgl&umur=$umur&penyebab=$penyebab");
  }
}
?>
